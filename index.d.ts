...
declare namespace WAWebJS {
  export class Client extends EventEmitter {
    ...
    /** Puppeteer page running */
    pupPage?: puppeteer.Page;

    /** Puppeteer browser running */
  ...
  export interface ClientOptions {
     ...
     */
    session?: ClientSession;
    /** If another session is detected (another browser), take over the session in the current browser
     * @default false */
  ...
  export class RemoteAuth extends AuthStrategy {
    public clientId?: string;
    public dataPath?: string;
    constructor(options?: {store: Store; clientId?: string; dataPath?: string; backupSyncIntervalMs: number});
  }
