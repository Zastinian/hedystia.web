...
exports.ExposeStore = (moduleRaidStr) => {
  ...
  window.Store.UserConstructor = window.mR.findModule((module) =>
    module.default && module.default.prototype && module.default.prototype.isServer && module.default.prototype.isUser ? module.default : null
  )[0].default;
  ...
  window.findProxyModel = (name) => {
    ...
    const results = window.mR.findModule((m) =>
      names.includes(m.default?.prototype?.proxyName || m[name]?.prototype?.proxyName || m[baseName]?.prototype?.proxyName)
    )[0];
    ...
    (func, args) => {
      ...
      if (message.hydratedButtons) {
        ...
        if (proto.conversation) {
          ...
          let found;
          const mediaPart = ["documentMessage", "imageMessage", "locationMessage", "videoMessage"];
          ...
          if (hydratedTemplate.hydratedTitleText && !hydratedTemplate.hydratedContentText) {
            hydratedTemplate.hydratedContentText = hydratedTemplate.hydratedTitleText;
          }
          ...
          if (found === "locationMessage") {
            if (!hydratedTemplate.hydratedContentText && (message[found].name || message[found].address)) {
          ...
          hydratedTemplate.hydratedContentText = hydratedTemplate.hydratedContentText || " ";
