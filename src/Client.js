...
/**
 * Starting point for interacting with the API
 ...
 * @param {number} options.takeoverOnConflict - If another session is detected (another browser), take over the session in the current browser
